...
ARGS="
--n_gpu $NUM_GPU
--output_dir checkpoints/llama-lb-9b
--run_name llama-lb-9b
--seed 42
--train_set_path DKYoon/slimorca-200k-english
--output_exists True
--enc_name_or_path DKYoon/mt5-large-lm-adapt
--lm_name_or_path microsoft/Orca-2-7b
--multi_lm bigscience/bloomz-1b1
--alignments1 linear
--alignments linear
...
if [ $NUM_GPU == 1 ]; then
    ...
    CUDA_VISIBLE_DEVICES=3 python train_langbridge.py $ARGS
else
...
# --strategy deepspeed_stage_2 --strategy ddp_find_unused_parameters_true